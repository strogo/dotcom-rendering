...
import { SignInGateProps, CurrentABTest, SignInGateComponent } from './types';
    ...
    return (
        <div className={cx(signinGate)}>
            ...
            <h1 className={cx(headingStyles)}>
                TEST Register for free and continue reading
            </h1>
...
export const signInGateTest1Component: SignInGateComponent = {
    gate: SignInGate,
    canShow,
};
